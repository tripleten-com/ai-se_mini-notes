...
// TODO: Chapter 3 Lesson 1 - strengthen these route contracts with params, body, and response types.
...
export async function postNote(req: CreateNoteRequest, res: Response) {
